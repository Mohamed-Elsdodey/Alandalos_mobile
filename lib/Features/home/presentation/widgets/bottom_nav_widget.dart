        ...
        return Scaffold(
          ...
          bottomNavigationBar: Container(
            ...
            child: GNav(
              ...
              tabBorderRadius: context.screenWidth * .06,
              tabActiveBorder: Border.all(
                  color: kPrimaryColor,
                  width: context.screenWidth * .012), // tab button border
              curve: Curves.linear, // tab animation curves
              duration:
                  const Duration(milliseconds: 500), // tab animation duration
              gap: context.screenWidth *
                  .002, // the tab button gap between icon and text
              color: kBottomNavIconsColor, // unselected icon color
              activeColor: Colors.white, // selected icon and text color
              iconSize: context.screenWidth * .05, // tab button icon size
              tabBackgroundColor:
                  kPrimaryColor, // selected tab background color
              padding:  EdgeInsets.symmetric(
                  horizontal: context.screenWidth*0.03, vertical: 5), // navigation bar padding
              tabs: [
                GButton(
                ...
                GButton(
                  ...
                  text: context.locale.translate("personal_account")!,
                ),
                GButton(
                  icon: Icons.settings,
